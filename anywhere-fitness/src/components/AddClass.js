      ...
      <div id="addClass-form">
        <div id="addClass-top-banner">
            <a className="addClass-nav-a" href="#">Home</a>
                ...
                <a className="addClass-nav-a" href="#">Login</a>
        ...
        <div className="addClass-field"><label className="addClass-form-labels">Class Size </label> <input onChange={this.textHandler} name="classSize" type="number" min="0" className="login-form-inputs"/></div>
        <div className="addClass-field"><label className="addClass-form-labels">Class Length (minutes) </label> <input onChange={this.textHandler} name="classLength" type="number" min="0" className="login-form-inputs"/></div>
